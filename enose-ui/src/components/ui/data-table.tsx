...
import { ArrowUpDown, ChevronDown, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, Search, Settings2, X } from "lucide-react";
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuLabel>切换列可见性</DropdownMenuLabel>
              <DropdownMenuSeparator />
              {table
                .getAllColumns()
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          {table.getFilteredSelectedRowModel().rows.length > 0 && (
            <span>，已选择 {table.getFilteredSelectedRowModel().rows.length} 条</span>
          )}
        </div>
