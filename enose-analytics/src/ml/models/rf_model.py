...
class RFModel(BaseModel):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._model: RandomForestClassifier | RandomForestRegressor | None = None
    ...
    def fit(
        ...
        # max_depth=0 表示不限制深度
        effective_max_depth = self.max_depth if self.max_depth and self.max_depth > 0 else None
    ...
    @classmethod
    def load_bytes(cls, data: bytes, **kwargs: Any) -> "RFModel":
        buf = io.BytesIO(data)
