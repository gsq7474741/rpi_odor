"""
SOAP Optimizer (https://arxiv.org/abs/2409.11321)
Code from https://github.com/nikhilvyas/SOAP
...
class SOAP(optim.Optimizer):
    ...
    def merge_dims(self, grad, max_precond_dim):
        """Merges dimensions of the gradient tensor."""
    ...
    def update_preconditioner(
        self, grad, state, max_precond_dim=10000, merge_dims=False, precondition_1d=False
    ):
    ...
    def get_orthogonal_matrix(self, mat):
        """Computes the eigenbases using torch.linalg.eigh decomposition."""
        matrix = []
        for m in mat:
            if len(m) == 0:
                matrix.append([])
    ...
    def get_orthogonal_matrix_QR(self, state, max_precond_dim=10000, merge_dims=False):
        """Computes eigenbases using power iteration + QR decomposition."""
